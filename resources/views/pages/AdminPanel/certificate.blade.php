...
<div class="main-wrapper col-sm-12 text-left h-100  pr-0 pl-0 " >
   <div class="col-sm-12 pl-0 pr-0 search-bars" >
      <!----------------
         ...
         ---------------->
      <div class="tab-nav ">
         <button class="tablinks active" onclick="schedules(event, 'schedule') ">Layouts</button>
         <button class="tablinks" onclick="schedules(event, 'request')">Requested Certificates</button>
         <button class="tablinks" onclick="schedules(event, 'type')">Certificate Types</button>
      </div>
               ...
               <div class="col-sm-12 overflow-auto pt-3 ">
                  <table id="certtype" class="dataTables_info table datatable-element  resident table-striped jambo_table bulk_action text-center border">
                     <thead>
                        <tr class="headings">
                           <th class="column-title">Action </th>
                           <th class="column-title">Certificate Types </th>
                        </tr>
                     </thead>
                  </table>
               </div>
                  ...
                  <div class="row">
                     <div class="col-md-12 order-md-1  pt-4" >
                        <form class="needs-validation" name="certform"  id="certform"  method="POST"  enctype="multipart/form-data">
                           ...
                           <div class="mb-3">
                              <label >Barangay Resident: Dimension: MAX:800px</label>
            ...
            <div class="col-sm-6 border solid overflow-auto">
               <div class="row">
                  <div class="column-right text-right" >
                     <img src="{{ URL::asset('images/lalawigan.png') }}" style="resize: both;width: 100px;margin-right: 30px;">
                  </div>
                  ...
                  <div class="column-left text-left" >
                     <img src="{{ URL::asset('images/lupao.png') }}" style="resize: both;width: 100px;margin-right: 30px;">
                  </div>
               </div>
               <div class="box">
                  ...
                  <div class="row text">
                     <div class="column-body-left text-center " >
                        <img src="{{ URL::asset('images/default.png') }}" style="resize: both;width: 75px;margin-right: 30px;">
                  ...
                  <div class="row text">
                     ...
                     <div class="column-body-right text-left " style="padding-left:5px">
                        ...
                        <div style=" text-indent: 50px;font-size: 17px ; font-family: Arial, Helvetica, sans-serif;text-justify: inter-word;">
                           <p >
                              This is to certify that ___________________, _____ years of age, ______ is a bonafide resident of <span id="firstcontent">start of the paragraph</span>
                           </p>
                           <br>
                           <p id="secondcontent">
                           ...
                           <br>
                           <p >
                              This certification is issued upon the request of _________________, this  ___ day of _______________, 2022 <span id="thirdcontent">start of the paragraph</span>
                           </p>
                           <br>
                        </div>
                        <div class="row">
