...
<body style="background-image: url({{ URL::asset('images/new.jpeg') }}); background-repeat:no-repeat; background-size: cover ">

@include('inc.admin_nav_login')
  ...
  <div class="row justify-content-center">
    <div class="col-sm-9 col-md-7 col-lg-5">
      <div class="card card-signin my-5">
        <div class="card-body">
          <h5 class="card-title text-center">Barangay Official Login</h5>
          {{-- form --}}
          ...
          {{-- end form --}}
          <br><a href="/barangay/login">Go to barangay resident login</a>
        </div>
      </div>
    </div>
  </div>
