...
@section('content')
    ...
    <h1 class="border-bottom border-bot pt-3">Blotter Records</h1>
    </div>
         ...
         <div class="modal-body">
                     ...
                     <div class="item form-group" style="margin-top: 1rem;">
                        <div class="col-md-12 col-sm-12 offset-md-4">
                           <button type="submit" id="saveBtn" class="btn btn-success">Save New Blotter</button>
   ...
   <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <h5>List of Persons Involved</h5>
