...
<div class="col-sm-12 text-left ">
   <h1 class="border-bottom border-bot pt-3">Barangay Settings</h1>
</div>
...
<div class="tab-nav ">
   ...
   <button class="tablinks" onclick="schedules(event, 'barangay')">Barangay Appointed Officials</button>
   <button class="tablinks" onclick="schedules(event, 'purok')">Areas/Puroks</button>
            ...
            <table id="official" class="dataTables_info table datatable-element  resident table-striped jambo_table bulk_action text-center border">
               <thead>
                  <tr class="headings">
                     ...
                     <th class="column-title">Start of Term </th>

                     <th class="column-title" > End of Term    </th>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <option value="Barangay VAWC">Barangay VAWC</option>
                            <option value="Peace Committee Chairman">Peace Committee Chairman</option>
                            <option value="Local Tanods">Local Tanods</option>
                          </select>
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-6 control-label">Start of Term</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="official_committe" name="official_committe" placeholder="Enter Start Term" value="" maxlength="50" required="">
                            <span id="official_committe_err" class="text-danger error-text official_committe_err"></span>

                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name" class="col-sm-4 control-label">End of Term</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="year_of_service" name="year_of_service" placeholder="Enter End Term" value="" maxlength="50" required="">
                  ...
                  <form class="needs-validation" novalidate="" action="{{ route('image.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <input  class="form-control" id="name" name="barangay_name" value="{{ $Barangayimage->barangay_name ?? '' }}" placeholder="Ex: Barangay Namulandayan">
                        <div class="invalid-feedback">
                     ...
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="city" name="city" value="{{ $Barangayimage->city ?? '' }}"placeholder="Ex: Lupao" required="">
                        <div class="invalid-feedback">
                           Input Field Required
                        </div>
                     </div>
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="province" value="{{ $Barangayimage->province ?? '' }}" name="province" placeholder="Ex: Nueva Ecija" required="">
                        <div class="invalid-feedback">
                           Input Field Required
                        </div>
                     </div>
...
<div class="modal fade" id="areamodal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" >Create Areas/Puroks</h4>
            </div>
            <div class="modal-body">
                <form id="areaform" name="areaform" class="form-horizontal">
                   ...
                   <input type="hidden" name="area_id" id="area_id">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="area" name="area" placeholder="Enter Areas/Puroks" value="" maxlength="50" required="">
