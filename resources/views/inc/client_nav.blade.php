<header class="header-blue" style="padding-bottom: 0px;">
    <nav class="navbar navbar-primary navbar-expand-md navigation-clean-search">
        <div class="container-fluid"><a class="navbar-brand" href="/barangay/home" style="font-size: 45px;font-family: bodoni mt;"><img src="{{ URL::asset('images/lupao.png')}}" style="resize: both;width: 100px;margin-right: 30px;"><p class="navbar-brand" id="client_navbar" style="font-size: 45px;">{{ $image->barangay_name ?? 'eBRGY' }}</p></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <div class="dropdown" style="font-size: 20px;"><a class="dropdown-toggle" aria-expanded="false" data-toggle="dropdown" href="#" style="color: white;"><i class="fa fa-cog" style="margin-right: 5px;"></i>Settings</a>
                    <div class="dropdown-menu dropleft" style="resize: both;width: 80px;padding: 0px;"><a class="dropdown-item" href="/barangay/accountsetting" style="resize: both;width: 80px;padding: 5px;font-size: 75%;">Account Settings</a>
                        <a class="dropdown-item" href="/barangay/logout" style="resize: both;width: 80px;padding: 5px;font-size: 75%;">Logout</a>
                    </div>
                </div>
                <div class="dropdown-menu dropleft" style="resize: both;width: 80px;padding: 0px;"><a class="dropdown-item" href="#" style="resize: both;width: 80px;padding: 5px;font-size: 75%;">Account Settings</a></div>
            </div>
            </div>
        </div>
    </nav>
...
<ul class="nav nav-tabs" style="margin-left: 20px;">
    ...
    <li class="nav-item"><a class="nav-link" href="/barangay/news">Events and Announcements</a></li>
    <li class="nav-item"><a class="nav-link" href="/barangay/news">Projects list</a></li>
    <li class="nav-item"><a class="nav-link" href="/barangay/news">Tourist Spots list</a></li>
    ...
    <li class="nav-item"><a class="nav-link" href="/barangay/info">Other Info</a></li>
</ul>
